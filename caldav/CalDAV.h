...
#ifndef H_CALDAV_CALDAV
#define H_CALDAV_CALDAV

#include "mapidefs.h"
#include "ECChannel.h"
#include "mapix.h"

HRESULT HrSetupListners(int *lpulNormalSocket, int *lpulSecureSocket);
HRESULT HrProcessConnections(int ulNormalSocket, int ulSecureSocket);
HRESULT HrAccept(int ulListenSocket, int *lpulClientSocket);
