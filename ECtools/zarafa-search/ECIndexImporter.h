...
public:
    ...
    public:
        ...
        ArchiveItem(const std::string &strStoreId, const std::string &strEntryId) {
    ...
    static HRESULT Create(ECConfig *lpConfig, ECLogger *lpLogger, IMsgStore *lpMsgStore, ECThreadData *lpThreadData, ECIndexDB *lpIndex, GUID guidServer, ECIndexImporter **lppImporter);
...
private:
    ...
    SPropTagArrayPtr m_lpArchiveProps;
    ...
    ECIndexImporter(ECConfig *lpConfig, ECLogger *lpLogger, IMsgStore *lpStore, ECThreadData *lpThreadData, ECIndexDB *lpIndex, GUID guidServer);
    ~ECIndexImporter();
